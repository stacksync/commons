...
public interface ISyncService extends Remote {
	...
	/***
	 * Returns a list containing all metadata objects in a workspace for a given user.  
     ...
     * @param commitObjects List of {@link ObjectMetadata} with the newly modified objects
     */
    @AsyncMethod
